...
### Problema
Vendedores do StartCRM atualmente precisam alternar entre o CRM e múltiplos aplicativos externos (WhatsApp, Instagram) para se comunicar com clientes. Isso resulta em:
...
### Solução
Criar um **Inbox Unificado** dentro do StartCRM onde vendedores podem:
...
│                                         │
│  URL: https://api.startcrm.com/webhook  │
...
O StartCRM já usa Vercel AI SDK. A solução usa o parâmetro `additional_instructions` que permite **instruções dinâmicas por execução** mantendo o histórico:
...
- [Vercel AI SDK](https://sdk.vercel.ai/docs) - Integração existente no StartCRM
...
| Feature | HubSpot | Intercom | Kommo | Freshworks | Chatwoot | **StartCRM** |
|---------|---------|----------|-------|------------|----------|--------------|
| Unified Inbox | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| WhatsApp nativo | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
### Dependências Internas (StartCRM)
...
O StartCRM já possui um Design System maduro (globals.css). Esta seção define tokens **específicos para Messaging** que estendem o sistema existente.
