...
Adicionar Evolution API como terceiro provider de WhatsApp no StartCRM, seguindo exatamente o padrão já estabelecido por Z-API e Meta Cloud API. O AI agent, HITL, pipeline e todas as demais features funcionam automaticamente — apenas os adaptadores de entrada/saída mudam.
