// OpenAPI 3.1.2 "source of truth" for StartCRM Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'StartCRM Public API',
      version: 'v1',
      description:
        'API pública do StartCRM para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
